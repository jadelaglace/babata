...
| P8 | AC-09（P8.1 最低覆盖）、AC-11 | P8.1 已完成 15/15；P8.2 中豆包第二/第三阶段、微信第二阶段和第三阶段其他范围已完成，132 个群聊按用户决定暂缓；P8.3 已启动，语雀/Kimi/ChatGPT 等用户范围完成，飞书 Drive、Bilibili、小红书、知乎和浏览器书签保留真实缺口 |
