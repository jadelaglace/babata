...
P8  来源广度、豆包/微信后续阶段与全量 A1             进行中（微信第三阶段群聊暂缓，P8.3 未开始）
...
| P8 | AC-09（P8.1 最低覆盖）、AC-11 | P8.1 已完成 15/15；P8.2 中豆包第二/第三阶段、微信第二阶段和第三阶段其他范围已完成，132 个群聊按用户决定暂缓；P8.3 尚未启动 |
