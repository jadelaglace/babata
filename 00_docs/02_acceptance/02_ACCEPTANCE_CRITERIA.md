...
2. 用户可以建立并修订地图/方向、知识、案例、日志和感悟；知识与案例能够双向引用，
   日志能够区分长期、中期、短期和实时切片，感悟保留第一方作者与版本。
...
5. 每一项人工判断都保留作者、时间、目标、依据或关联来源及自身版本；修改形成
...
10. 至少一个真实工作例能够从“审阅一条资料”走到“形成可回顾、可关联、可继续使用
