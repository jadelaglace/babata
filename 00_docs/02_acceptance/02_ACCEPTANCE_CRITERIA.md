...
状态（2026-07-22）：P6.2 已通过第 1–4、7 项。可重建搜索投影、组合检索、评分筛选/
排序、可解释浮现和关系导航均已由 fixture 与真实 C0/C1 验证；媒体-only 已有真实资料，
附件-only、受限和缺失状态由隔离 fixture 验证，未为验收伪造真实资料。第 5–6 项的版本化
子库定义、人工纳入/排除和物化保护属于 P6.3，尚未通过；因此 AC-07 整体仍未通过。
