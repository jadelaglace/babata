...
description: >
  ...
  A1/A2 sovereignty recovery to complete before registration. Use when the user asks to collect, recover, import,
...
3. Use browser, Lark, desktop-control, platform CLI, and official export tools only as acquisition
   dependencies. They may produce A1/A2 captured or prepared results, but do not own formal C0.
...
originals, report their A1/A2 and captured/prepared status as "拿回但未正式登记", and stop.
...
per candidate. Always report sovereignty depth A1/A2/A3+ and readiness captured/prepared/registered,
