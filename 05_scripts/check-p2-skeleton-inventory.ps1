...
if ($actualRust.Count -ne 145) { throw "Expected 145 current Rust source files, found $($actualRust.Count)" }
...
Write-Output 'P2 skeleton inventory passed: 137-file P2 baseline plus 8 post-P2 activation files, 6 crates, and corrected peripheral skeletons.'
