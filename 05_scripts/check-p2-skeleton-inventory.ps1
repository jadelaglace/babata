...
if ($actualRust.Count -ne 157) { throw "Expected 157 current Rust source files, found $($actualRust.Count)" }
...
Write-Output 'P2 skeleton inventory passed: 137-file P2 baseline plus 20 post-P2 activation files, 6 crates, and corrected peripheral skeletons.'
