...
if ($actualRust.Count -ne 144) { throw "Expected 144 current Rust source files, found $($actualRust.Count)" }
...
Write-Output 'P2 skeleton inventory passed: 137-file P2 baseline plus 7 P4 collection files, 6 crates, and corrected peripheral skeletons.'
