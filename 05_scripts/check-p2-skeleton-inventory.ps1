...
lib.rs dto.rs error.rs ports/mod.rs ports/raw_repository.rs ports/asset_store.rs ports/derived_repository.rs ports/job_repository.rs ports/process_provider.rs ports/source_adapter.rs ports/candidate_runner.rs ports/read_projection.rs ports/view_builder.rs ports/output_builder.rs ports/backup_driver.rs ports/capability_registry.rs ports/clock.rs usecases/mod.rs usecases/collector.rs usecases/capture.rs usecases/workspace.rs usecases/knowledge.rs usecases/process.rs usecases/explore.rs usecases/sublibraries.rs usecases/views.rs usecases/outputs.rs usecases/routes.rs usecases/ops.rs usecases/capabilities.rs
'@
    '03_babata_infrastructure' = @'
lib.rs config.rs paths.rs observability.rs capabilities.rs sqlite/mod.rs sqlite/migrate.rs sqlite/raw_repository.rs sqlite/derived_repository.rs sqlite/job_repository.rs sqlite/read_projection.rs assets/mod.rs assets/file_store.rs sources/mod.rs sources/registry.rs sources/candidate.rs sources/providers/mod.rs sources/providers/feishu.rs sources/providers/yuque.rs sources/providers/onenote.rs sources/providers/evernote.rs sources/providers/wechat.rs sources/providers/zhihu.rs sources/providers/bilibili.rs sources/providers/xiaohongshu.rs sources/providers/douyin.rs sources/providers/browser.rs sources/providers/conversations.rs sources/providers/local_files.rs sources/providers/first_party.rs processing/mod.rs processing/registry.rs processing/local_extract.rs processing/bailian_cli.rs processing/bailian_api.rs views/mod.rs views/datasette.rs views/obsidian.rs views/exports.rs views/sublibrary.rs views/output.rs views/manifest.rs backup/mod.rs backup/sqlite_snapshot.rs backup/restic.rs backup/manifest.rs tools/mod.rs tools/command_runner.rs tools/yt_dlp.rs security/mod.rs security/secrets.rs security/privacy.rs
'@
    '04_babata_cli' = @'
...
if ($actualRust.Count -ne 137) { throw "Expected 137 Rust source files, found $($actualRust.Count)" }
...
Write-Output 'P2 skeleton inventory passed: 6 crates, 137 Rust files, and corrected peripheral skeletons.'
