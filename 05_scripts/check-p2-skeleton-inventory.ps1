...
lib.rs config.rs paths.rs observability.rs capabilities.rs sqlite/mod.rs sqlite/migrate.rs sqlite/derived_migrate.rs sqlite/raw_repository.rs sqlite/derived_repository.rs sqlite/job_repository.rs sqlite/read_projection.rs sqlite/collection_migrate.rs sqlite/collection_repository.rs sqlite/knowledge_core_repository.rs assets/mod.rs assets/file_store.rs sources/mod.rs sources/registry.rs sources/candidate.rs sources/providers/mod.rs sources/providers/feishu.rs sources/providers/yuque.rs sources/providers/onenote.rs sources/providers/evernote.rs sources/providers/wechat.rs sources/providers/wechat_recovery.rs sources/providers/zhihu.rs sources/providers/bilibili.rs sources/providers/bilibili_collection.rs sources/providers/xiaohongshu.rs sources/providers/douyin.rs sources/providers/browser.rs sources/providers/conversations.rs sources/providers/doubao.rs sources/providers/kimi.rs sources/providers/chatgpt.rs sources/providers/local_files.rs sources/providers/youtube.rs sources/providers/first_party.rs processing/mod.rs processing/registry.rs processing/local_extract.rs processing/bailian_cli.rs processing/bailian_api.rs processing/semantic_digest.rs views/mod.rs views/dense_expression.rs views/datasette.rs views/obsidian.rs views/exports.rs views/sublibrary.rs views/output.rs views/manifest.rs backup/mod.rs backup/driver.rs backup/sqlite_snapshot.rs backup/restic.rs backup/manifest.rs tools/mod.rs tools/command_runner.rs tools/yt_dlp.rs security/mod.rs security/secrets.rs security/privacy.rs
'@
    '04_babata_cli' = @'
...
'@
    '05_babata_local_api' = @'
lib.rs main.rs app.rs state.rs auth.rs error.rs requests.rs responses.rs routes/mod.rs routes/collector.rs routes/capture.rs routes/workspace.rs routes/process.rs routes/explore.rs routes/sublibraries.rs routes/outputs.rs routes/health.rs
'@
    '06_babata_worker' = @'
...
if ($actualRust.Count -ne 160) { throw "Expected 160 current Rust source files, found $($actualRust.Count)" }
...
Write-Output 'P2 skeleton inventory passed: 137-file P2 baseline plus 23 post-P2 activation files, 6 crates, and corrected peripheral skeletons.'
