...
$checks = [ordered]@{
    ...
    'C2B output governance' = 'check-c2b-output-governance.ps1'
    'C2B output governance checker tests' = 'test-c2b-output-governance.ps1'
    'Knowledge-universe ontology governance' = 'check-knowledge-universe-ontology-governance.ps1'
    'Knowledge-universe ontology governance checker tests' = 'test-knowledge-universe-ontology-governance.ps1'
    'Intent and plan governance' = 'check-intent-plan-governance.ps1'
    'Intent and plan governance checker tests' = 'test-intent-plan-governance.ps1'
    'Batch round governance' = 'check-batch-round-governance.ps1'
    'Batch round runner tests' = 'test-babata-execution-round.ps1'
    'Batch round governance checker tests' = 'test-batch-round-governance.ps1'
