...
> [!IMPORTANT]
> Babata 仍处于开发阶段，不是面向普通用户的稳定发行版。当前已经完成 P0-P7、P8.1 和豆包第二/第三阶段；P8.2 继续处理微信第二/第三阶段，P8.3 处理计划内来源全量 C0-A1。简单备份同步属于 P9。
...
| P8 | 进行中 | P8.1 已完成 15/15 个计划内来源；P8.2 中豆包第二/第三阶段已完成，微信第二/第三阶段待推进；P8.3 尚未启动 |
