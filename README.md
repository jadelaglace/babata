...
> [!IMPORTANT]
> Babata 仍处于开发阶段，不是面向普通用户的稳定发行版。当前已经完成 P0-P7、P8.1、P8.4 与 P8.5 存量样本准备；新增抓取暂停，P8.3 保留真实全量缺口。简单备份同步属于 P9。
...
| P8 | 进行中 | P8.1 已完成 15/15；P8.2 除 132 个暂缓群聊外已完成；P8.3 暂停新增抓取并保留缺口；P8.4 完成 70 条 A2 样本；P8.5 将其中 45 条推进到 C0-B，另 25 条保持 C0-C |
