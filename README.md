...
> [!IMPORTANT]
> Babata 仍处于开发阶段，不是面向普通用户的稳定发行版。当前已经完成 P0-P7；P8.1 已让每个计划内来源至少保存 5 条真实 C0-A1 或更高数据，P8.2/P8.3 继续处理豆包、微信后续阶段与计划内来源全量 C0-A1。简单备份同步属于 P9。
...
| P8 | 进行中 | P8.1 每来源至少 5 条 C0-A1 已完成；P8.2/P8.3 继续豆包、微信后续阶段与计划内来源全量 A1 |
