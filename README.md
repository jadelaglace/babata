...
> [!IMPORTANT]
> Babata 仍处于开发阶段，不是面向普通用户的稳定发行版。当前已经完成 P0-P5 与 P6.1 核心知识沉淀；P6.2 检索与关系导航、P6.3 子库与通用输出尚未完成。
...
| P6.2 | 下一阶段 | 搜索投影、多条件检索、评分排序、关系导航与可解释浮现 |
| P6.3 | 未开始 | 子库与通用输出 |
